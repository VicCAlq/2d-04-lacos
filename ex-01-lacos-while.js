...
while (i8 < nomes.length) {
  resposta08.push(nomes[i8].toUpperCase())
  i8++
}
...
while (i10 < nomes.length) {
  if (nomes[i10].length > resposta10.length) {
    resposta10 = nomes[i10]
  }
  i10++
}
