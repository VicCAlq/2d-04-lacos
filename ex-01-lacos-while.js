...
if (numeros(contador) < 0){negativos++}
contador++
...
while(i05 >= 0){nomesI.push(nomesI[i05])
i05--

}

export const resposta05 = nomesI
...
while (nomes(i06) < nomes.length)
{
lista06.push(nomes(106))
i06 += 2
...
if (nomes(i07) < nomes(i07).length <= 5){
